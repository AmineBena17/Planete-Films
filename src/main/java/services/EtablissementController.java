...
import beans.EtablissementFacade;
...
public class EtablissementController implements Serializable {
    ...
    @EJB
    private beans.EtablissementFacade ejbFacade;
    ...
    public Etablissement getEtablissement(java.lang.Integer id) {
    ...
    public static class EtablissementControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Etablissement) {
                ...
                return getStringKey(o.getIdEtab());
            } else {
